          ...
          <div className="grid gap-8 md:grid-cols-2">
            {coreFeatures.map((feature, index) => {
              ...
              return (
                <div
                  key={index}
                  className="group relative overflow-hidden rounded-2xl border border-border bg-bg-secondary p-8 hover:border-primary/50 transition-all duration-300"
                >
                  ...
                  <div key={category.category}>
                    ...
                    <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
                      {category.features.map((feature, idx) => (
                        <div
                          key={idx}
                          className="group p-4 rounded-lg border border-border bg-bg-secondary/50 hover:bg-bg-secondary hover:border-primary/30 transition-all"
                        >
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-4">
            {integrations.map((integration, idx) => {
              ...
              return (
                <div
                  key={idx}
                  className="group p-6 rounded-lg border border-border bg-bg-secondary/50 hover:bg-bg-secondary hover:border-primary/30 transition-all flex flex-col items-center justify-center"
                >
