    ...
    <>
      ...
      <section className="relative min-h-[90vh] flex items-center justify-center overflow-hidden bg-[#08090a] pt-20 px-6">
        ...
        <div className="relative mx-auto max-w-7xl py-24 sm:py-32">
          <div className="mx-auto max-w-5xl">
            <div className="rounded-2xl bg-gradient-to-b from-white/[0.04] to-white/[0.02] border border-white/[0.08] backdrop-blur-sm p-12 text-center ring-1 ring-white/10 shadow-glow-blue hover:shadow-glow-blue-lg transition-all duration-300">
            {/* Main headline */}
            <h1 className={cn(
          ...
          <div className="mt-16 relative animate-fade-in-up animation-delay-500">
            <div className="mx-auto max-w-5xl">
              <div className="rounded-2xl bg-gradient-to-b from-white/[0.04] to-white/[0.02] border border-white/[0.08] p-1 backdrop-blur-sm ring-1 ring-white/10 shadow-glow-blue">
      ...
      <section className="py-16 bg-[#08090a]">
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="rounded-2xl bg-gradient-to-b from-white/[0.04] to-white/[0.02] border border-white/[0.08] backdrop-blur-sm p-8 ring-1 ring-white/10 shadow-glow-blue hover:shadow-glow-blue-lg transition-all duration-300">
