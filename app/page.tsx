...
export default function HomePage() {
  ...
  return (
    <>
      ...
      {/* Hero Section - Dark gradient background like Linear */}
      <section className="relative min-h-[100vh] flex items-center justify-center overflow-hidden bg-[#0A0B0D]">
        {/* Animated gradient background */}
        <div className="absolute inset-0 bg-gradient-to-br from-blue-600/5 via-blue-500/5 to-transparent" />
        ...
        <div className="relative mx-auto max-w-7xl px-6 py-24 sm:py-32 lg:px-8">
          <div className="mx-auto max-w-5xl text-center">
            ...
            <h1 className={cn(
              ...
              <span className="text-white">AuraRev is a purpose-built tool for</span>
              <br />
            ...
            <p className="mx-auto max-w-3xl text-lg sm:text-xl text-gray-400 mb-10 animate-fade-in-up animation-delay-200">
            ...
            {/* Trust text */}
            <p className="mt-8 text-sm text-gray-500 animate-fade-in-up animation-delay-400">
          ...
          <div className="mt-20 relative animate-fade-in-up animation-delay-500">
            <div className="mx-auto max-w-6xl">
              <div className="rounded-xl bg-gray-900/50 border border-gray-800 p-1 backdrop-blur-sm">
      ...
      {/* Trust Bar - Slightly lighter background */}
      <section className="py-12 bg-[#111318] border-y border-gray-800/50">
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <p className="text-center text-sm text-gray-500 mb-8 font-medium">
            Powering review management for leading businesses
          </p>
          <div className="grid grid-cols-3 md:grid-cols-6 gap-8 items-center">
            {customerLogos.map((customer, index) => (
              ...
              >
                <div className="text-lg font-semibold text-gray-400 hover:text-white transition-colors">
                  {customer.logo}
                </div>
              </div>
            ))}
      ...
      {/* Made for Modern Businesses - Dark background like Linear */}
      <section className="py-24 bg-[#0A0B0D]">
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div className="group relative overflow-hidden rounded-2xl bg-gradient-to-b from-gray-900 to-gray-950 border border-gray-800 p-8 hover:border-blue-600/50 transition-all duration-300">
